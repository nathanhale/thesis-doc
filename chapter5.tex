...
Figure~\ref{fig:TweetsForVaryingLambdaTweets} shows the results of the tweet recommendations for user $K_{i}$ when varying the $\lambda_{tweets}$ parameter. Figure~\ref{fig:UsersForVaryingLambdaTweets} shows the results of the user recommendations for user $K_{i}$ when varying the $\lambda_{tweets}$ parameter. %TODO: additional discussion once the graphs are in place

Figure~\ref{fig:TweetsForVaryingLambdaUsers} shows the results of the tweet recommendations for user $K_{i}$ when varying the $\lambda_{users}$ parameter. Figure~\ref{fig:UsersForVaryingLambdaUsers} shows the results of the user recommendations for user $K_{i}$ when varying the $\lambda_{users}$ parameter. %TODO: additional discussion once the graphs are in place
...
%%%% Varying lambda tweets -- tweet results

%lu 07 lt 09
%	@5: total is 17 (avg of 3.4), and 0.6 precision, with 2 fives
%	@10: total is 33 (avg of 3.3), and 0.6 precision, with 2 fives
%	@15: total is 44 (avg of 2.933333333333333), and 0.4 precision, with 2 fives
%	@20: total is 58 (avg of 2.9), and 0.3 precision, with 2 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__07_lu_075_lt_limited.txt.filtered.txt
%	@5: total is 17 (avg of 3.4), and 0.6 precision, with 2 fives
%	@10: total is 31 (avg of 3.1), and 0.5 precision, with 2 fives
%	@15: total is 44 (avg of 2.933333333333333), and 0.4 precision, with 2 fives
%	@20: total is 63 (avg of 3.15), and 0.4 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__lu_07_lt_06_limited.txt.filtered.txt
%	@5: total is 17 (avg of 3.4), and 0.6 precision, with 2 fives
%	@10: total is 29 (avg of 2.9), and 0.4 precision, with 2 fives
%	@15: total is 48 (avg of 3.2), and 0.4666666666666667 precision, with 4 fives
%	@20: total is 62 (avg of 3.1), and 0.4 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__lambda_tweets_045_limited.txt.filtered.txt
%	@5: total is 15 (avg of 3.0), and 0.4 precision, with 2 fives
%	@10: total is 29 (avg of 2.9), and 0.3 precision, with 2 fives
%	@15: total is 44 (avg of 2.933333333333333), and 0.3333333333333333 precision, with 2 fives
%	@20: total is 63 (avg of 3.15), and 0.4 precision, with 4 fives



%%% Varying lambda users -- tweet results

%TODO: verify the time on this to make sure there's nothing weird with it
%Run experiments for /home/nathan/eval_results/filtered/tweets__0_3_lu_369_back_in_limited.txt.filtered.txt
%	@5: total is 17 (avg of 3.4), and 0.6 precision, with 2 fives
%	@10: total is 33 (avg of 3.3), and 0.6 precision, with 2 fives
%	@15: total is 45 (avg of 3.0), and 0.4 precision, with 2 fives
%	@20: total is 62 (avg of 3.1), and 0.4 precision, with 2 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__0_4_lambda_users_limited.txt.filtered.txt
%	@5: total is 17 (avg of 3.4), and 0.6 precision, with 2 fives
%	@10: total is 33 (avg of 3.3), and 0.6 precision, with 2 fives
%	@15: total is 45 (avg of 3.0), and 0.4 precision, with 2 fives
%	@20: total is 62 (avg of 3.1), and 0.4 precision, with 2 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__0_5_lambda_users_limited.txt.filtered.txt
%	@5: total is 17 (avg of 3.4), and 0.6 precision, with 2 fives
%	@10: total is 33 (avg of 3.3), and 0.6 precision, with 2 fives
%	@15: total is 45 (avg of 3.0), and 0.4 precision, with 2 fives
%	@20: total is 60 (avg of 3.0), and 0.35 precision, with 2 fives
...
%Run experiments for /home/nathan/eval_results/filtered/tweets__0_9_lambda_users_limited.txt.filtered.txt
%	@5: total is 16 (avg of 3.2), and 0.4 precision, with 2 fives
%	@10: total is 27 (avg of 2.7), and 0.2 precision, with 2 fives
%	@15: total is 47 (avg of 3.1333333333333333), and 0.4666666666666667 precision, with 2 fives
%	@20: total is 66 (avg of 3.3), and 0.55 precision, with 3 fives





%%% Varying lambda users --- user results

%Run experiments for /home/nathan/eval_results/filtered/users__lambda_tweets_045_limited.txt
%	@5: total is 13 (avg of 2.6), and 0.4 precision, with 1 fives
%	@10: total is 35 (avg of 3.5), and 0.7 precision, with 3 fives
%	@15: total is 51 (avg of 3.4), and 0.6 precision, with 3 fives
%	@20: total is 71 (avg of 3.55), and 0.65 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/users__lu_07_lt_06_limited.txt
%	@5: total is 13 (avg of 2.6), and 0.4 precision, with 1 fives
%	@10: total is 35 (avg of 3.5), and 0.7 precision, with 3 fives
%	@15: total is 51 (avg of 3.4), and 0.6 precision, with 3 fives
%	@20: total is 71 (avg of 3.55), and 0.65 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/users__07_lu_075_lt_limited.txt
%	@5: total is 15 (avg of 3.0), and 0.6 precision, with 1 fives
%	@10: total is 37 (avg of 3.7), and 0.8 precision, with 3 fives
%	@15: total is 56 (avg of 3.7333333333333334), and 0.7333333333333333 precision, with 4 fives
%	@20: total is 71 (avg of 3.55), and 0.65 precision, with 4 fives

%09 lt
%Run experiments for /home/nathan/eval_results/filtered/users__first_try_all_edges_limited.txt
%	@5: total is 15 (avg of 3.0), and 0.6 precision, with 1 fives
%	@10: total is 37 (avg of 3.7), and 0.8 precision, with 3 fives
%	@15: total is 56 (avg of 3.7333333333333334), and 0.7333333333333333 precision, with 4 fives
%	@20: total is 73 (avg of 3.65), and 0.7 precision, with 4 fives



%%% Varying lambda users --- tweet results

%Find out the date and stuff on this one...
%Run experiments for /home/nathan/eval_results/filtered/users__0_3_lu_369_back_in_limited.txt
%	@5: total is 15 (avg of 3.0), and 0.6 precision, with 1 fives
%	@10: total is 37 (avg of 3.7), and 0.8 precision, with 3 fives
%	@15: total is 54 (avg of 3.6), and 0.6666666666666666 precision, with 4 fives
%	@20: total is 72 (avg of 3.6), and 0.65 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/users__0_4_lambda_users_limited.txt
%	@5: total is 15 (avg of 3.0), and 0.6 precision, with 1 fives
%	@10: total is 37 (avg of 3.7), and 0.8 precision, with 3 fives
%	@15: total is 54 (avg of 3.6), and 0.6666666666666666 precision, with 4 fives
%	@20: total is 72 (avg of 3.6), and 0.65 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/users__0_5_lambda_users_limited.txt
%	@5: total is 15 (avg of 3.0), and 0.6 precision, with 1 fives
%	@10: total is 37 (avg of 3.7), and 0.8 precision, with 3 fives
%	@15: total is 56 (avg of 3.7333333333333334), and 0.7333333333333333 precision, with 4 fives
%	@20: total is 72 (avg of 3.6), and 0.65 precision, with 4 fives
...
%Run experiments for /home/nathan/eval_results/filtered/users__0_9_lambda_users_limited.txt
%	@5: total is 13 (avg of 2.6), and 0.2 precision, with 0 fives
%	@10: total is 24 (avg of 2.4), and 0.1 precision, with 0 fives
%	@15: total is 38 (avg of 2.533333333333333), and 0.13333333333333333 precision, with 0 fives
%	@20: total is 51 (avg of 2.55), and 0.2 precision, with 0 fives
...
%%% Small amount of data for varying lambda tweets, with lambda users at 0.9

%user k_j

%Run experiments for /home/nathan/eval_results/filtered/tweets__lambdasAt0_9_limited.txt.filtered.txt
%	@5: total is 15 (avg of 3.0), and 0.0 precision, with 0 fives
%	@10: total is 33 (avg of 3.3), and 0.3 precision, with 0 fives
%	@15: total is 51 (avg of 3.4), and 0.4 precision, with 0 fives
%	@20: total is 68 (avg of 3.4), and 0.4 precision, with 0 fives

%Run experiments for /home/nathan/eval_results/filtered/users__lambdasAt0_9_limited.txt
%	@5: total is 8 (avg of 1.6), and 0.2 precision, with 0 fives
%	@10: total is 20 (avg of 2.0), and 0.1 precision, with 0 fives
%	@15: total is 38 (avg of 2.533333333333333), and 0.26666666666666666 precision, with 2 fives
%	@20: total is 50 (avg of 2.5), and 0.25 precision, with 2 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__lu_09_lt_07_limited.txt.filtered.txt
%	@5: total is 13 (avg of 2.6), and 0.0 precision, with 0 fives
%	@10: total is 29 (avg of 2.9), and 0.1 precision, with 0 fives
%	@15: total is 45 (avg of 3.0), and 0.2 precision, with 0 fives
%	@20: total is 62 (avg of 3.1), and 0.25 precision, with 0 fives

%Run experiments for /home/nathan/eval_results/filtered/users__lu_09_lt_07_limited.txt
%	@5: total is 9 (avg of 1.8), and 0.2 precision, with 1 fives
%	@10: total is 27 (avg of 2.7), and 0.4 precision, with 2 fives
%	@15: total is 43 (avg of 2.8666666666666667), and 0.3333333333333333 precision, with 3 fives
%	@20: total is 61 (avg of 3.05), and 0.4 precision, with 4 fives

%Run experiments for /home/nathan/eval_results/filtered/tweets__lu_09_lt_03_limited.txt.filtered.txt
%	@5: total is 13 (avg of 2.6), and 0.0 precision, with 0 fives
%	@10: total is 27 (avg of 2.7), and 0.1 precision, with 0 fives
%	@15: total is 39 (avg of 2.6), and 0.06666666666666667 precision, with 0 fives
%	@20: total is 52 (avg of 2.6), and 0.05 precision, with 0 fives

%Run experiments for /home/nathan/eval_results/filtered/users__lu_09_lt_03_limited.txt
%	@5: total is 11 (avg of 2.2), and 0.2 precision, with 1 fives
%	@10: total is 28 (avg of 2.8), and 0.3 precision, with 2 fives
%	@15: total is 43 (avg of 2.8666666666666667), and 0.26666666666666666 precision, with 3 fives
%	@20: total is 49 (avg of 2.45), and 0.2 precision, with 3 fives
